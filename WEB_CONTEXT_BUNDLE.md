...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.37-kirby-problem-4.37-6c838f28-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.37"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.37-kirby-problem-4.37-6c838f28-v1",
      "problem_contract_sha256": "0831dbe90f089562d8ea8ebfacc5fe124fa888a0a354e9e4e35d13d861d11558",
      "problem_id": "problem:um-kp-4.37-kirby-problem-4.37-6c838f28",
      "route_id": "route:um-kp-4.37-kirby-problem-4.37-6c838f28-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.37-kirby-problem-4.37-6c838f28-source-fidelity-01",
      "graph_id": "graph:um-kp-4.37-kirby-problem-4.37-6c838f28-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.37-kirby-problem-4.37-6c838f28-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.37-kirby-problem-4.37-6c838f28-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(Kinoshita conjecture). Does every projective plane in $S^{4}$ decompose as a connected sum of a knotted 2-sphere and an unknotted projective plane?"
          },
          "statement_sha256": "c6880abbd0acabc83aaabd2da067551c290fac11ca50b3781ee2bc950fdd96b9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.37-kirby-problem-4.37-6c838f28-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.37-kirby-problem-4.37-6c838f28-root",
      "route_id": "route:um-kp-4.37-kirby-problem-4.37-6c838f28-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.37-6bd360442999",
        "url": "https://www.unsolvedmath.com/problems/KP-4.37"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
